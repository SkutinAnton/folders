...
Эта документация описывает общие подходы к структуре папок. Будут встречаться моменты которые не будут подходить ни под одно правило и тогда они будут добавлены в исключение. Такие моменты нужно обсуждать всем вместе для принятия правильного решения.
