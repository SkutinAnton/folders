...
- [Преобразование типа для использования функций библиотеки date-fns](#преобразование-типа-для-использования-функций-библиотеки-date-fns)
...
## Преобразование типа для использования функций библиотеки date-fns

#### Зачем?
compareAsc (и другие функции date-fns) раньше принимали string, а с новой версией они принимают number и Date (все функции этой библиотеки не проходил может еще принимают какой-то тип, надо смотреть в документации при использовании)

#### Как?
Если у вас значение типа string то нужно:

- если значение в таком формате "2018-01-01" (обычно мы такое пишем сами вручную), то нужно просто его обернуть функцией parseISO из date-fns

- если значение приходит из формы в таком формате "01.01.2018" (обычно оно такое и приходит), то его нужно обернуть в функцию parseDateValue которая сделает значениие таким "2018-01-01" и обернет его в parseISO
